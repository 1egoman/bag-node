...
exports.http = (app) ->
  ...
  app.get "/icon/:name", (req, res) ->
    ...
    request "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=ff50460ec1cde1c406c3c9281da0fae2&text=#{name}&per_page=1&sort=relevance&format=json", (err, resp, body) ->
      if err
        res.send err
      else
        # generate the photo
